...
export default function Navbar() {
    ...
    const links = <>
    <li><NavLink className={({isActive})=> (isActive ? "text-green-400" : "")} to='/books'>All Books</NavLink></li>
  ...
  <div className="navbar-start">
    <NavLink to='/books' className="text-green-400 hidden md:block"><strong>Book</strong>Heaven</NavLink>
